export default {
  ...
  privacySecurity: {
    ...
    userBody: 'Your resume content, photo, JSON, and on-device draft are processed in this browser and are not sent to a backend or Cloudflare Web Analytics. The page uses Cloudflare Web Analytics without cookies or user-level identifiers for aggregate page-view and performance metrics. Once fully loaded and kept open, it can be used offline for editing, saving, JSON export, and PDF creation.',
    technicalHeading: 'For technical users',
    technicalBody: 'In the F12 Network panel, you can see same-origin static assets plus the fixed Cloudflare beacon script and standard RUM endpoint. No other external runtime requests are made.',
