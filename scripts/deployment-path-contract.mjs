...
export const DEPLOYMENT_PATH_CONTRACTS = Object.freeze([
  ...
  Object.freeze({
    artifactPath: 'schema/resume-studio-web-v3.schema.json', kind: 'json', marker: '"title": "Resume Studio web v3 export"', semantic: 'json-schema', urlPath: 'schema/resume-studio-web-v3.schema.json'
  }),
  Object.freeze({
    artifactPath: 'schema/resume-studio-web-v3.example.json', kind: 'json', marker: '"documents":', semantic: 'import-example', urlPath: 'schema/resume-studio-web-v3.example.json'
  }),
  Object.freeze({
