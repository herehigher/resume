...
export const DEPLOYMENT_PATH_CONTRACTS = Object.freeze([
  ...
  Object.freeze({
    artifactPath: 'schema/resume-studio-web-v4.schema.json', kind: 'json', marker: '"title": "Resume Studio web v4 export"', semantic: 'json-schema', urlPath: 'schema/resume-studio-web-v4.schema.json'
  }),
  Object.freeze({
    artifactPath: 'schema/resume-studio-web-v4.example.json', kind: 'json', marker: '"documents":', semantic: 'import-example', urlPath: 'schema/resume-studio-web-v4.example.json'
  }),
  Object.freeze({
