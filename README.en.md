...
- If saving or migration fails, the existing draft and decryption key are retained. When the browser cannot use Web Locks, saving, deletion, and migration stop to avoid conflicts. Export JSON before reopening in a supported browser.
