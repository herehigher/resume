...
[Project overview](README.md) | [简体中文](README.zh-CN.md) | [English](README.en.md)
...
公開 Demo は準備中です（Issue #9）。公開 URL が検証されるまでは、下記のローカル起動方法を利用してください。
...
本番 runtime に外部 API、CDN、外部 font、analytics を追加しないでください。詳しくは [Contributing](CONTRIBUTING.md) と [release acceptance checklist](docs/acceptance-checklist.md) を参照してください。
